...
<head>
    ...
    <link href="{{ asset("cssAdmin/pages/dashboard.css") }}" rel="stylesheet">
    <!-- You can change the theme colors from here -->
    <link href="{{ asset("cssAdmin/colors/default-dark.css") }}" id="theme" rel="stylesheet">
